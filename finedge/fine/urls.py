...
urlpatterns = [
    ...
    path('restore-record/', views.restore_record, name='restore_record'),

    
    path('toggle-payroll-status/', views.toggle_payroll_status, name='toggle_payroll_status'),
   
    # Report URLs - add these
    path('reports/payroll/', views.get_payroll_report, name='get_payroll_report'),
    path('reports/attendance/', views.get_attendance_report, name='get_attendance_report'),
    path('reports/combined/', views.get_combined_report, name='get_combined_report'),
